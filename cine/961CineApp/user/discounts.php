			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">OUR DISCOUNTS FOR STUDENTS</h2>
						<!-- end section title -->
				...
				<div class="col-6">
					<div class="filter__content">
						<div class="filter__items">
                            <form action="shows-discounted.php?uid=<?php echo $uid ?>" method="POST">
							<!-- filter item -->
							<div class="filter__item" id="filter__genre">
								<span class="filter__item-label">SELECT YOUR SCHOOL:</span>
								<select class="sign__input" style="width:450px" name="school">
<?php
include_once 'conx.php';
...
?>
							...
							<div class="filter__item" id="filter__quality">
								<span class="filter__item-label">ENTER COUPON CODE:</span>
								<input type="text" style="width:200px" class="sign__input" name="code">
							</div>
						...
						<!-- filter btn -->
						<button class="sign__btn" type="submit" style="width:200px">Submit</button>
						<!-- end filter btn -->
					</div></form>
				</div>
			</div>
