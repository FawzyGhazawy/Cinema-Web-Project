				...
				<div class="col-6">
					<div class="filter__content">
						<div class="filter__items">
                            <form action="filter-movies.php?uid=<?php echo $uid ?>" method="POST">
							<!-- filter item -->
							<div class="filter__item" id="filter__genre">
								<span class="filter__item-label">SELECT MOVIE'S GENRE:</span>
								<select class="sign__input" name="genre">
<?php
include_once 'conx.php';
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card">
						<div class="card__cover">
							<img src="../posters/<?php echo $row['poster'] ?>" style="height:250px;">
