				...
				<div class="row">
					<div class="col-12">
						<div class="header__content">
							...
							<img src="../img/logo.jpg" alt="" style="width:70px;height:70px">							</a>
							<!-- end header logo -->
				...
				<div class="col-6">
					<div class="filter__content">
						<div class="filter__items">
                            <form action="filter-shows.php?uid=<?php echo $uid ?>" method="POST">
							<!-- filter item -->
							<div class="filter__item" id="filter__genre">
								<span class="filter__item-label">SELECT SHOW'S DATE':</span>
								<input type="date" class="sign__input"  name="date">
							</div>
                            <!-- end filter item -->
						</div>
						
						<!-- filter btn -->
						<button class="sign__btn" type="submit">Apply Filter</button>
						<!-- end filter btn -->
					</div></form>
				</div>
			</div>
