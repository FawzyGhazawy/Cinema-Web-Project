				...
				<div class="col-12">
					<div class="section__wrap">
						...
						<ul class="breadcrumb">
                            ...
                            <li class="breadcrumb__item breadcrumb__item--active">Ice Creams</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
				...
				<div class="col-3 col-sm-3 col-lg-3 col-xl-3">
					<div class="card">
						<div class="card__cover">
							<a href="menu/popcorn.php?uid=<?php echo $uid ?>">
							<img src="../beverages-pics/<?php echo $row['picture'] ?>" style="height:300px"></a>
