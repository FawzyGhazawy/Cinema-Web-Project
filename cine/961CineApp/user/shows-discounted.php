...
if(isset($_POST['school']) && isset($_POST['code'])){
$school = $_POST['school'];
$code = $_POST['code'];

$result1 = mysqli_query($con,"SELECT * FROM discounts WHERE schoolName='$school' AND couponCode='$code'");
if(mysqli_num_rows($result1)===1){
    $row1 = mysqli_fetch_array($result1);
    $percent = $row1['percentage'];
}
else{
header("student-error.php?uid=$uid");
}}
?>
					...
					<div class="col-12">
						<div class="header__content">
							...
							<ul class="header__nav">
                                ...
                                <li class="header__nav-item">
									<a href="discounts.php?uid=<?php echo $uid ?>" class="header__nav-link--active">DISCOUNTS</a>
								</li>
								<!-- end dropdown -->
			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">DISCOUNTED SHOWS FOR STUDENTS</h2>
						<!-- end section title -->

						<!-- breadcrumb -->
						<ul class="breadcrumb">
							<li class="breadcrumb__item"><a href="home-page.php?uid=<?php echo $uid ?>">Home</a></li>
							<li class="breadcrumb__item breadcrumb__item--active">Discounted Shows</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
				...
				<div class="col-12">
					<div class="filter__content">
						<div class="filter__items">
                            <h3 style="color:#fff"> You got a <span style="color:#d4af37"><?php echo $percent ?>% Discount</span>
                             for all  shows from <?php echo $school ?> </h3>
				        </div>
                    </div>
		        </div>
	        </div>
...
if(mysqli_num_rows($result)>0){
      while($row = mysqli_fetch_array($result)){
        ...
        $newPrice = $ticketPrice - $ticketPrice * ($percent/100);
?>
				<!-- card -->
						...
						<div class="row">
							...
							<div class="col-12 col-sm-8">
								<div class="card__content">
									...
									<div class="card__description" style="color:#fff">
										<h3>Ticket price:
                                            <span style="text-decoration: line-through"> <?php echo $row['ticketPrice'] ?>.00 USD       </span>
                                            <span style="color: #d4af37"> <?php echo  $newPrice ?> USD</span></h3>
									</div>
