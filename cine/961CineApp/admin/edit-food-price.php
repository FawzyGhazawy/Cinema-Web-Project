			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">EDIT BEVERAGES</h2>
						<!-- end section title -->

						<!-- breadcrumb -->
						<ul class="breadcrumb">
							<li class="breadcrumb__item"><a href="home-page.php">Home</a></li>
							<li class="breadcrumb__item breadcrumb__item--active">Edit Price</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
...
$result = mysqli_query($con,"SELECT * FROM beverages where beverageID='" . $_GET["fid"] . "'");
$row = mysqli_fetch_array($result);
       
?>
						<!-- form of add movie -->			
						<form action="save-food-price.php?fid=<?php echo $row['beverageID'] ?>" class="sign__form" method="POST" enctype="multipart/form-data">
							 <div class="sign__group">
							<label class="sign__text">Old Price: $ <?php echo $row['price'] ?></label>
