			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">ADD MOVIES</h2>
						<!-- end section title -->

						<!-- breadcrumb -->
						<ul class="breadcrumb">
							<li class="breadcrumb__item"><a href="home-page.php">Home</a></li>
							<li class="breadcrumb__item breadcrumb__item--active">Add New Movie</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
	...
	<div class="section">
		<div class="container">
			<div class="row">
						...
						<!-- form of add movie -->			
						<form action="save-movie.php" class="sign__form" method="POST" enctype="multipart/form-data">
							<div class="sign__group">
							<label class="sign__text"> Title </label>
								<input type="text" class="sign__input" style="width:1000px" name="title">
							</div>

							<div class="sign__group">
								<label class="sign__text"> Category </label>
								<select class="sign__input" style="width:1000px"  name="category">
<?php
...
<?php
							...
							<div class="sign__group">
							<label class="sign__text"> Duration </label>
								<input type="text" class="sign__input" style="width:1000px" name="duration">
							</div>

							<div class="sign__group">
							<label class="sign__text"> Release Date </label>
								<input type="date" class="sign__input" style="width:1000px" name="releaseDate">
							</div>

							<div class="sign__group">
							<label class="sign__text"> Language </label>
								<input type="text" class="sign__input" style="width:1000px"  name="language">
							</div>

							<div class="sign__group">
							<label class="sign__text"> Poster </label>
								<input type="file" class="sign__input" style="width:1000px" name="poster">
							</div>

							<div class="sign__group">
							<label class="sign__text"> Trailer </label>
								<input type="file" class="sign__input" style="width:1000px" name="trailer">
							</div>
							<button class="sign__btn" type="submit">Save Movie</button>
                        </form>
