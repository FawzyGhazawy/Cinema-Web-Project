					...
					<div class="col-12">
						<div class="header__content">
							...
							<ul class="header__nav">
								...
								<li class="header__nav-item">
									<a href="statistics.php" class="header__nav-link--active">STATISTICS</a>
								</li>
			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">SALES</h2>
						<!-- end section title -->

						<!-- breadcrumb -->
						<ul class="breadcrumb">
							<li class="breadcrumb__item"><a href="home-page.php">Home</a></li>
							<li class="breadcrumb__item breadcrumb__item--active">Sales</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
				...
				<div class="col-12 col-sm-12 col-lg-12">
						...
						<table class="table" style="color:#fff">
  							<thead>
								...
								<th scope="col">Total Number of Tickets Sold</th>
...
while($row=mysqli_fetch_array($result)){
    $mid = $row['movieID'];
       ...
       $result2 = mysqli_query($con,"SELECT * FROM booking WHERE movieID='$mid'");
       if(mysqli_num_rows($result2)>0){
		$totalNumberofTickets=0; $totalProfit=0;
       while($row2=mysqli_fetch_array($result2)){
        $totalNumberofBooking = mysqli_num_rows($result2);
        $totalNumberofTickets += $row2['numberOfTickets'];
        $totalProfit += ($totalAmount = $row2['discountedPrice'] * $row2['numberOfTickets']);
    }
?>
    							<tr>
                                 <td><?php echo $i ?></td>
                                 <td><?php echo $row['title'] ?></td>
      							<td><?php echo $totalNumberofBooking ?></td>
                                <td><?php echo $totalNumberofTickets ?></td>
                                <td style="color: #d4af37"><?php echo $totalProfit ?> USD</td>
