					...
					<div class="col-12">
						<div class="header__content">
							...
							<ul class="header__nav">
                                ...
                                <li class="header__nav-item">
									<a href="movies.php" class="header__nav-link--active">MOVIES</a>
								</li>
						...
						<div class="row">
							<div class="col-12 col-sm-4">
								<div class="card__cover">
									...
									<a href="../trailers/<?php echo $row['trailer'] ?>" class="card__play">
...
<br>
										...
										<a style="color:#d4af37" href="delete-movie.php?mid=<?php echo $row['movieID'] ?>" style="color:#ff55a5">
                                        <i class="icon ion-ios-trash"></i>Delete</a>
									</div>
                                </div>
							</div>
						</div>
