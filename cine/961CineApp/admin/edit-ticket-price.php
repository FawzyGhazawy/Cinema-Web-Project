			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">EDIT SHOWS</h2>
						<!-- end section title -->

						<!-- breadcrumb -->
						<ul class="breadcrumb">
							<li class="breadcrumb__item"><a href="home-page.php">Home</a></li>
							<li class="breadcrumb__item breadcrumb__item--active">Edit Ticket Price</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
...
$result = mysqli_query($con,"SELECT * FROM shows where showID='" . $_GET["shid"] . "'");
$row = mysqli_fetch_array($result);
       
?>
						<!-- form of add movie -->			
						<form action="save-new-price.php?shid=<?php echo $row['showID'] ?>" class="sign__form" method="POST" enctype="multipart/form-data">
							 <div class="sign__group">
							<label class="sign__text">Old Ticket Price: $ <?php echo $row['ticketPrice'] ?></label>
								<input type="number" class="sign__input" style="width:1000px" 
                                placeholder="Enter New Price in USD" name="newPrice">
							</div>
							<button class="sign__btn" type="submit">SAVE NEW PRICE</button>
                        </form>
