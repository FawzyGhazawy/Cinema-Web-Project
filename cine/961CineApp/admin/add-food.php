			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">ADD FOODS AND BEVERAGES</h2>
						<!-- end section title -->

						<!-- breadcrumb -->
						<ul class="breadcrumb">
							<li class="breadcrumb__item"><a href="home-page.php">Home</a></li>
							<li class="breadcrumb__item breadcrumb__item--active">Add New Food</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
	...
	<div class="section">
		<div class="container">
			<div class="row">
						...
						<!-- form of add movie -->			
						<form action="save-food.php" class="sign__form" method="POST" enctype="multipart/form-data">
							<div class="sign__group">
							<label class="sign__text"> Name </label>
								<input type="text" class="sign__input" style="width:1000px" name="name">
							</div>
							...
							<div class="sign__group">
							<label class="sign__text"> Price(USD)</label>
								<input type="number" class="sign__input" style="width:1000px" name="price">
							</div>

							<div class="sign__group">
							<label class="sign__text"> Picture </label>
								<input type="file" class="sign__input" style="width:1000px" name="pic">
							</div>

							<button class="sign__btn" type="submit">Save Beverage</button>
                        </form>
