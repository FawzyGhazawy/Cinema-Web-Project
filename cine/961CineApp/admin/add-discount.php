			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">ADD DISCOUNT</h2>
						<!-- end section title -->

						<!-- breadcrumb -->
						<ul class="breadcrumb">
							<li class="breadcrumb__item"><a href="home-page.php">Home</a></li>
							<li class="breadcrumb__item breadcrumb__item--active">Add New Discount</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
	...
	<div class="section">
		<div class="container">
			<div class="row">
						...
						<!-- form of add movie -->			
						<form action="save-discount.php" class="sign__form" method="POST" enctype="multipart/form-data">
							<div class="sign__group">
							<label class="sign__text"> School Name </label>
								<input type="text" class="sign__input" style="width:1000px" name="school">
							</div>

							<div class="sign__group">
							<label class="sign__text"> Discount Percentage </label>
								<input type="number" class="sign__input" style="width:1000px" name="percentage">
							</div>

                            <div class="sign__group">
							<label class="sign__text"> Coupon Code </label>
								<input type="text" class="sign__input" style="width:1000px" name="code">
							</div>
							<button class="sign__btn" type="submit">Save Discount</button>
                        </form>
